...
fname = 'Data_oud/Specimen_3/'
    
ZLP_y14 = np.loadtxt(fname + "Position-13-Specimen_EELS-Spectrum_m0d93eV-to-9d07eV.txt")
ZLP_y15 = np.loadtxt(fname + "Position-12-Specimen_EELS-Spectrum_m0d93eV-to-9d07eV.txt")
ZLP_y16 = np.loadtxt(fname + "Position-11-Specimen_EELS-Spectrum_m0d93eV-to-9d07eV.txt")
ZLP_y17 = np.loadtxt(fname + "Position-1-Vacuum_EELS-Spectrum_m0d93eV-to-9d07eV.txt")
ZLP_y19 = np.loadtxt(fname + "Position-10-Specimen_EELS-Spectrum_m0d93eV-to-9d07eV.txt")
ZLP_y20 = np.loadtxt(fname + "Position-9-Specimen_EELS-Spectrum_m0d93eV-to-9d07eV.txt")
ZLP_y21 = np.loadtxt(fname + "Position-8-Specimen_EELS-Spectrum_m0d93eV-to-9d07eV.txt")
ZLP_y22 = np.loadtxt(fname + "Position-2-Vacuum_EELS-Spectrum_m0d93eV-to-9d07eV.txt")
ZLP_y23 = np.loadtxt(fname + "Position-3-Vacuum_EELS-Spectrum_m0d93eV-to-9d07eV.txt")
...
for i, file in enumerate([file14, file15, file16, file17, file19, file20, file21, file22, file23]):
    ...
    #mijn
    i_max_y = np.argmax(file.y)
    zeropoint2 = file.x[i_max_y]
    print (zeropoint2)
