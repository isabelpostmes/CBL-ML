...
and
  ...
  %
  {\color{red} In Appendix~\ref{app:corr},
    we evaluate the correlation coefficients associated
    to representative training datasets and
     elaborate on the possible role played
  by systematic correlated uncertainties.}
