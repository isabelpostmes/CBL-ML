...
\title[Mapping Electron Energy Loss Spectra with Machine Learning]{Neural network approach to access the low-loss region in electron energy loss spectroscopy}

\author{ Laurien, Luigi, Juan, Sonia, ...}

\address{TUD and Nikhef}
...
of WS$_2$ and study its local electronic properties.
\end{abstract}

\noindent{\it Keywords:} Transmission Electron Microscopy,
Electron Energy Loss Spectroscopy, Neural Networks, Bandgap, van
der Waals materials.\\
