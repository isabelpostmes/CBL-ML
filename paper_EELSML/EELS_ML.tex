...
that from the inelastic scatterings off the sample.
%
Here we deploy machine learning techniques, inspired by applications in particle physics,
to realise a model-independent multidimensional determination of the ZLP
with a faithful uncertainty estimate.
%
Our method is used to disentangle ZLP from
sample contributions in  low-loss EEL spectra acquired
in WS$_2$ nanostructures.
%
This has made it possible to determine the value and nature of the WS$_2$ bandgap
as a function of the underlying crystalline morphology of the nanostructures,
as well as it has allowed for a clean mapping of exciton peaks down to 
$\Delta E\simeq 1.5$ eV.
%
