...
\mr
1        & 100                 & 200                  & 15          & 2048               & -0.96              & 8.51     & $23\pm3 $         \\
2        & 100                 & 60                   & 7           & 2048               & -0.54              & 5.59    & $ 25 \pm 2$         \\
3        & 10                  & 200                  & 12          & 2048               & -0.18              & 2.97      & $ ~7 \pm 4$         \\
4        & 10                  & 60                   & 6           & 2048               & -0.40              & 4.78       & $17 \pm 2$         \\ 
\br
  \end{tabular}
    \end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 We point out that since here we are interested in the low-loss region, $\Delta E_{\rm max}$ does not need
    ...
    from 7 eV to 25 eV depending on the specific operation conditions of the microscope,
    with an standard deviation between 2 and 4 eV.
    %
...
In Table~\ref{table:chi2summary} we indicate the values of the final $\chi^2$ per data point,
    ...
    %
    From the results of this table we can see that indeed this expectation is satisfied,
