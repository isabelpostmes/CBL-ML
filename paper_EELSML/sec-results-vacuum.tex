...
\begin{figure}[t]
    ...
    \caption{\small The model predictions for the FWHM of the zero loss peak
      ...
      corresponding microscope parameter for which training data is available.
    }
...
In the same way as in the case of the electron beam energy $E_b$, while our ZLP model
...
All in all, we conclude that the predictions of the ZLP model based on vacuum spectra
