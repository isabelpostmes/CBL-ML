...
\begin{figure}[ht]
    ...
    \caption{The ratio between the central experimental value of the total
      ...
      total uncertainty defined in Eq.~(\ref{eq:standarddev}).
      %
...
%
The experimental uncertainties $\sigma^{(\rm exp)}_i$ of the pseudo-data points are chosen as 1/10 of the 
...
\subsection{Dependence on the electron energy loss $\Delta E$.}
%
