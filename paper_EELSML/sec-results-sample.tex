...
The optimal values of $\Delta E_{\rm I}$ listed in Table~\ref{table:sampledata_summary} can be
...
%
 ...
 &&\mathcal{F} = \exp\lp -\frac{\lp \Delta E - \Delta E_{\rm I} \rp^2 }{\lp \Delta E_0 - \Delta E_{\rm I} \rp^2 \delta^2} \rp  \, , \label{eq:matching} \\
 ...
 One particularly important application of ZLP-subtracted spectra is the
