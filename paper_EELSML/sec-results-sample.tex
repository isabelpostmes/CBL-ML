...
well for the spectra under consideration, irrespective of the spectral resolution.
%
...
spectra have been recorded with a superior spectral resolution, then the resulting ZLP model uncertainties
...
%
This is clearly not possible in this case, and indeed fits restricted to $\Delta E\le 1.4$ eV
turn out to be numerically unstable.
%
Instead of studying the bandgap properties, one could exploit the ZLP-subtracted results of sample B
to study the local
excitonic transitions that are expected in the ultra-low-loss region of the spectra.
%
At first glance, it might be argued that the peaks present in Fig.~\ref{fig:SubtractedEELS_plot_sp4} are not
...
displays a
comparison of the ZLP-subtracted spectra recorded in the (spatially separated) locations \#4, \#5 and \#6
in sample B
...
the associated uncertainty estimate that allows establishing their significance.
%
Further insights between the properties of the excition peaks in the ultra-low-loss region
