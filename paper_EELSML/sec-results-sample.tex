...
effects from the sample are still present, although diminishable.
 %
...
Fig.~\ref{fig:subtracted_spectra_comp} then displays the
...
Fig.~\ref{fig:bvalues_sampleB} displays
same comparison as Fig.~\label{fig:bvalues_sampleA} now for sp4 in sample B.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[t]
\begin{centering}
  \includegraphics[width=0.99\linewidth]{plots/Stability_plots_sp4.pdf}
  \caption{Same as Fig.~\label{fig:bvalues_sampleA} now for sp4 in sample B.
   }
\label{fig:bvalues_sampleB}
\end{centering}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
