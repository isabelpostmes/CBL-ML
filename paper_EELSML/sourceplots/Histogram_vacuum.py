...
plt.hist(chi_data['Best chi2 value'], density=True, bins=50, range=[0, 4], alpha=.8, label='training')
plt.hist(chi_data['val'], density=True, bins=50, range=[0, 4], alpha=.4, label='validation')
